...
import type { Block, Log, Trace, Transaction, TransactionReceipt, Transfer } from '../types/eth.js';
...
import type { Abi, Address, BlockTag, Chain, Hex, LogTopic, RpcBlock, RpcTransaction, RpcTransactionReceipt, Transport, Log as ViemLog } from "viem";
export type DatabaseConfig = {
    ...
    kind: "postgres";
    poolConfig: Prettify<PoolConfig & {
        max: number;
    }>;
};
...
export type Filter = LogFilter | BlockFilter | TransferFilter | TransactionFilter | TraceFilter;
export type FilterWithoutBlocks = Omit<BlockFilter, "fromBlock" | "toBlock"> | Omit<TransactionFilter, "fromBlock" | "toBlock"> | Omit<TraceFilter, "fromBlock" | "toBlock"> | Omit<LogFilter, "fromBlock" | "toBlock"> | Omit<TransferFilter, "fromBlock" | "toBlock">;
/** Filter that matches addresses. */
export type Factory = LogFactory;
export type FilterAddress<factory extends Factory | undefined = Factory | undefined> = factory extends Factory ? factory : Address | Address[] | undefined;
export type LogFilter<factory extends Factory | undefined = Factory | undefined> = {
    type: "log";
    chainId: number;
...
export type TransferFilter<fromFactory extends Factory | undefined = Factory | undefined, toFactory extends Factory | undefined = Factory | undefined> = {
    type: "transfer";
    chainId: number;
...
export type TransactionFilter<fromFactory extends Factory | undefined = Factory | undefined, toFactory extends Factory | undefined = Factory | undefined> = {
    type: "transaction";
    chainId: number;
    fromAddress: FilterAddress<fromFactory>;
    toAddress: FilterAddress<toFactory>;
...
export type TraceFilter<fromFactory extends Factory | undefined = Factory | undefined, toFactory extends Factory | undefined = Factory | undefined> = {
    type: "trace";
    chainId: number;
    fromAddress: FilterAddress<fromFactory>;
    toAddress: FilterAddress<toFactory>;
...
export type FragmentAddress = Address | {
    address: Address;
    eventSelector: Factory["eventSelector"];
    childAddressLocation: Factory["childAddressLocation"];
} | null;
export type FragmentAddressId = Address | `${Address}_${Factory["eventSelector"]}_${Factory["childAddressLocation"]}` | null;
...
export type ContractSource<filter extends "log" | "trace" = "log" | "trace", factory extends Factory | undefined = Factory | undefined, fromFactory extends Factory | undefined = Factory | undefined, toFactory extends Factory | undefined = Factory | undefined> = {
    filter: filter extends "log" ? LogFilter<factory> : TraceFilter<fromFactory, toFactory>;
} & ContractMetadata;
export type AccountSource<filter extends "transaction" | "transfer" = "transaction" | "transfer", fromFactory extends Factory | undefined = Factory | undefined, toFactory extends Factory | undefined = Factory | undefined> = {
...
export type SyncBlock = Prettify<MakeOptional<RpcBlock<Exclude<BlockTag, "pending">, true>, "size">>;
...
export type SyncTrace = {
    trace: DebugTrace["result"] & {
        index: number;
        subcalls: number;
    };
    transactionHash: DebugTrace["txHash"];
};
export type LightBlock = Pick<SyncBlock, "hash" | "parentHash" | "number" | "timestamp">;
...
export type Event = LogEvent | BlockEvent | TransactionEvent | TransferEvent | TraceEvent;
