...
export declare const createCachedViemClient: ({ common, indexingBuild, requestQueues, syncStore, eventCount, }: {
    common: Common;
...
export declare const cachedTransport: ({ common, network, requestQueue, syncStore, cache, }: {
    common: Common;
    network: Network;
