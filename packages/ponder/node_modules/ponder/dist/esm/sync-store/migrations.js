  ...
  `))
    ...
    "2025_02_19_0_primary_key": {
        async up(db) {
            ...
            // 7. reset metadata
            console.log(`${new Date().toISOString()} [ponder_sync migration] started 2025_02_19_0_primary_key`);
            await db.executeQuery(sql `SET statement_timeout = 3600000;`.compile(db));
            ...
            console.log(`${new Date().toISOString()} [ponder_sync migration] dropped indexes`);
            await db.schema
                .alterTable("logs")
            ...
            console.log(`${new Date().toISOString()} [ponder_sync migration] updated column types`);
            ...
            console.log(`${new Date().toISOString()} [ponder_sync migration] dropped columns`);
            await db.schema
                .alterTable("logs")
            ...
            await db.schema
                ...
                .execute();
            console.log(`${new Date().toISOString()} [ponder_sync migration] renamed columns`);
            await db.schema
                .alterTable("logs")
            ...
            await db.schema
                ...
                .execute();
            console.log(`${new Date().toISOString()} [ponder_sync migration] added primary keys`);
            ...
            console.log(`${new Date().toISOString()} [ponder_sync migration] finished 2025_02_19_0_primary_key`);
        },
    },
    "2025_02_26_0_factories": {
        async up(db) {
            console.log(`${new Date().toISOString()} [ponder_sync migration] started 2025_02_26_0_factories`);
            await db.executeQuery(sql `SET statement_timeout = 3600000;`.compile(db));
            ...
            await db.schema
                ...
                .column("factory_id")
                .execute();
            console.log(`${new Date().toISOString()} [ponder_sync migration] finished 2025_02_26_0_factories`);
        },
    },
    "2025_02_26_1_rpc_request_results": {
        async up(db) {
            console.log(`${new Date().toISOString()} [ponder_sync migration] started 2025_02_26_1_rpc_request_results`);
            await db.executeQuery(sql `SET statement_timeout = 3600000;`.compile(db));
            await db.schema
                .alterTable("rpc_request_results")
            ...
            console.log(`${new Date().toISOString()} [ponder_sync migration] finished 2025_02_26_1_rpc_request_results`);
        },
    },
};
